...
//更改为懒加载
const Login = () =>
    import ( /* webpackChunkName: "login_signUp_home" */ '../components/users/Login.vue')
const SignUp = () =>
    import ( /* webpackChunkName: "login_signUp_home" */ '../components/users/SignUp.vue')
const Home = () =>
    import ( /* webpackChunkName: "login_signUp_home" */ '../components/users/Home.vue')

const Books = () =>
    import ( /* webpackChunkName: "books_myBooks" */ '../components/users/Books.vue')
const MyBooks = () =>
    import ( /* webpackChunkName: "books_myBooks" */ '../components/users/MyBooks.vue')

const User = () =>
    import ( /* webpackChunkName: "user" */ '../components/management/user/User.vue')

const Welcome = () =>
    import ( /* webpackChunkName: "welcome_adminHome_adminLogin" */ '../components/management/Welcome.vue')
const AdminHome = () =>
    import ( /* webpackChunkName: "welcome_adminHome_adminLogin" */ '../components/management/AdminHome.vue')
const AdminLogin = () =>
    import ( /* webpackChunkName: "welcome_adminHome_adminLogin" */ '../components/management/AdminLogin.vue')

const AddBook = () =>
    import ( /* webpackChunkName: "addBook_changeBook_borrowed" */ '../components/management/book/AddBook.vue')
const ChangeBook = () =>
    import ( /* webpackChunkName: "addBook_changeBook_borrowed" */ '../components/management/book/ChangeBook.vue')
const Borrowed = () =>
    import ( /* webpackChunkName: "addBook_changeBook_borrowed" */ '../components/management/book/Borrowed.vue')
